...
const SearchBar = () => {
  ...
  const updateSearchParams = (model: string, manufacturer: string) => {
    ...
    model ? searchParams.set('model', model) : searchParams.delete('model', model)
    model ? searchParams.set('manufacturer', manufacturer) : searchParams.delete('manufacturer', manufacturer)
